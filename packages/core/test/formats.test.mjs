 ...
 * documented layout. Byte-identity against the ORIGINAL tool's output must be
 * confirmed against a real install (see docs/ARCHITECTURE.md milestone 2). TRB
 * repack is a documented best-effort inverse of unpack and does NOT perform IMGB
 * texture pairing.
 */
