 ...
 * against a real game install must be confirmed separately against original
 * archive files.
 */
...
// Regression: filelist seed derivation must SIGN-EXTEND (the seed is a signed
// int32 widened to a 64-bit value). When header[9]'s high bit is set, the upper
// 4 seed bytes are 0xFF, not 0x00. Validated against a real FFXIII-2 filelist
// whose header byte[9]=0xa1 yields seed f5ca56a1ffffffff.
{
