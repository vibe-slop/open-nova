/**
 * Cross-platform Steam / Proton discovery using portable filesystem probing
 * that works on Linux, the Steam Deck, macOS and Windows (rather than reading
 * the Steam path, active-user id, and per-game "Running" flag from the Windows
 * registry).
 *
 * Strategy:
