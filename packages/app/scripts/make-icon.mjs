...
// Prefers the real bundled icon (build/icon.png — the original open-nova mark);
// falls back to a generated placeholder so the build never fails if it's missing.
